    ...
    def forward(self, x):
        ...
        if self.outside_block_checkpointing:
            ...
            x = checkpoint.checkpoint(
                self.down_0, x_res_0, self.dummy_tensor, use_reentrant=False
            )
            x_res_1 = self.iterative_checkpoint(self.enc_block_1, x)
            x = checkpoint.checkpoint(
                self.down_1, x_res_1, self.dummy_tensor, use_reentrant=False
            )
            x_res_2 = self.iterative_checkpoint(self.enc_block_2, x)
            x = checkpoint.checkpoint(
                self.down_2, x_res_2, self.dummy_tensor, use_reentrant=False
            )
            x_res_3 = self.iterative_checkpoint(self.enc_block_3, x)
            x = checkpoint.checkpoint(
                self.down_3, x_res_3, self.dummy_tensor, use_reentrant=False
            )
            ...
            x_up_3 = checkpoint.checkpoint(
                self.up_3, x, self.dummy_tensor, use_reentrant=False
            )
            ...
            x_up_2 = checkpoint.checkpoint(
                self.up_2, x, self.dummy_tensor, use_reentrant=False
            )
            ...
            x_up_1 = checkpoint.checkpoint(
                self.up_1, x, self.dummy_tensor, use_reentrant=False
            )
            ...
            x_up_0 = checkpoint.checkpoint(
                self.up_0, x, self.dummy_tensor, use_reentrant=False
            )
            ...
            x = checkpoint.checkpoint(
                self.out_0, x, self.dummy_tensor, use_reentrant=False
            )
